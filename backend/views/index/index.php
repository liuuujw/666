    ...
    <div class="row-fluid">
        ...
        <div class="box chat alt span5 noMargin" ontablet="span12" ondesktop="span5">
            ...
            <div class="contacts">
                <ul class="list">
                    <li>
                        <img class="avatar" src="./image/avatar.jpg" alt="avatar"/>
                        <span class="name">Łukasz Holeczek</span>
                        <span class="status online"></span>
                        <span class="important">4</span>
                    </li>
                    <li>
                        <img class="avatar" src="./image/avatar2.jpg" alt="avatar"/>
                        <span class="name">Łukasz Holeczek</span>
                        <span class="status offline"></span>
                    </li>
                    <li>
                        <img class="avatar" src="./image/avatar3.jpg" alt="avatar"/>
                        <span class="name">Łukasz Holeczek</span>
            ...
            <div class="conversation">
                <div class="actions">
                    <img class="avatar" src="./image/avatar.jpg" alt="avatar"/>
                    <img class="avatar" src="./image/avatar3.jpg" alt="avatar"/>
                    <img class="avatar" src="./image/avatar4.jpg" alt="avatar"/>
                </div>
                <ul class="talk">
                    <li>
                        <img class="avatar" src="./image/avatar3.jpg" alt="avatar"/>
                        ...
                        <div class="message">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy
                            nibh
            ...
            <ul>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="author">
                                <img src="./image/avatar3.jpg" alt="avatar"/>
                            </div>
                        ...
                        <li>
                            <div class="author">
                                <img src="./image/avatar6.jpg" alt="avatar"/>
                            </div>
                ...
                <li>
                    <div class="author">
                        <img src="./image/avatar9.jpg" alt="avatar"/>
                    </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="author">
                                <img src="./image/avatar2.jpg" alt="avatar"/>
                            </div>
                        ...
                        <li>
                            <div class="author">
                                <img src="./image/avatar4.jpg" alt="avatar"/>
                            </div>
