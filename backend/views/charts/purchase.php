...
<!--                    <span class="show_time_year"></span>-<span class="show_time-month"></span>-->
                ...
                <div id="purchase_total" style="width: 100%;height:500px;"></div>
            </div>
        </div>
    </div>
</div>
...
$this->registerJsFile('js/charts/purchase.js',['depends' => ['frontend\assets\AppAsset'], 'position' => $this::POS_HEAD]);
?>
